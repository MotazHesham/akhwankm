                            ...
                            <b>
                                ...
                                @if ($approvementForms->approved == 'approved')
                                    ...
                                    <label class="gry-color strong" style="float:right"> (<input name="intern_extern"
                                            type="checkbox" checked>) : الموافقة
                                        <br>
                                        <label class="gry-color strong" style="float:right"> (<input
                                                name="intern_extern" type="checkbox">) : عدم الموافقة
                                        @else
                                            <label class="gry-color strong" style="float:right"> (<input
                                                    name="intern_extern" type="checkbox">) : الموافقة
                                                <br>
                                                <label class="gry-color strong" style="float:right"> (<input
                                                        name="intern_extern" type="checkbox" checked>) : عدم الموافقة
                    ...
                    <table style="padding: 1.5rem;float: right;position: relative;">
                        <tr>
                            <td class="text-right "><span><span> <label
                                            class="gry-color strong selectBoxLabel bold block" style="float:right"> مدير
                                            اللجنة الأخصائية الإجتماعية
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                            </td>
                            <td class="text-right "><span></span> <label class="gry-color strong" style="float:right">
                                    مدير اللجنة&nbsp;&nbsp;</label></td>
                        </tr>
                        <tr>
                            <td class="text-right "><span></span> <label
                        ...
                        <tr>
                            <td class="text-right "><span></span> <label
                                    class="gry-color strong selectBoxLabel bold block" style="float:right"> : التاريخ
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                            </td>
                            <td class="text-right "><span></span> <label class="gry-color strong" style="float:right">:
                                    التاريخ &nbsp;&nbsp;</label></td>
