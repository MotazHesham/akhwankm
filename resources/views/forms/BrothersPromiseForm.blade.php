...
<body style="background-color: rgb(253, 253, 253)">
    <div style="display: flex; justify-content: center;">
        <div style="width: 21.59cm; height: 30cm ;">
            ...
            <h2 style="background-color: #DDD ; text-align:center"> <span>استمارة رقم</span> <span>({{$bigBrother->id}})</span></h2>
            <br>
            <br>
            <div style="display: flex; justify-content: center;">
                <div style="border: 1px solid #000; width: 20cm;">
                    ...
                    <table style="padding: 1.5rem;float: right;position: relative;">
                        <tr>
                            <td class="text-right "><span></span> <label class="gry-color strong"
                                    style="float:right">&nbsp;اتعهـــد
                                    أنا:&nbsp;&nbsp;</label><span>{{ $userinfo->name }}</span> </td>
                            <td class="text-right "><span></span> <label class="gry-color strong" style="float:center">
                                    رقم الهوية : &nbsp;&nbsp;</label><span>{{ $userinfo->identity_number }}</span></td>
                            <td class="text-right "><span></span> <label
                                    class="gry-color strong selectBoxLabel bold block" style="float:right"> تاريخها :
                                    &nbsp;&nbsp;&nbsp;&nbsp;</label> <span>{{ $userinfo->identity_date }}</span></td>
                        </tr>
                    ...
                    <div class="s1">
                        ...
                        <b>
                            <ol style="list-style-type:arabic-indic ;direction:RTL; text-align: right;">
                                ...
                                <li> إن اختار الأخ الأخ الأكبر/الأخت اكبرى السيناريو ( 2 ) في سلم التآخي يكون أختلاط
                                    الأخ الأصغر/ الأخت الصغرى مع نفس الجنس من أبناء أسرة الأخ الأكبر/ الأخت الكبرى</li>
                            </ol>
                        </b>
