                        ...
                        <div class="d-flex justify-content-between">
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div class="ms-2 c-details">
                                    <h6 class="mb-0">{{ $outingRequest->outing_type->name_ar ?? '' }}</h6>
                                    <span>{{ $outingRequest->start_date ?? '' }}</span>
                                </div>
                            </div>
                            <div class="badge"> <span>{{ $outingRequest->status ? trans('global.outing_status.' . $outingRequest->status) : 'أخري' }}</span> </div>
                        </div>
                        <div class="mt-5">
