    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-BigBrother">
                ...
                <tbody>
                    @foreach($smallBrothers as $key => $smallBrothers)
                        <tr data-entry-id="{{ $smallBrothers->id }}">
                            <td>

                            </td>
                            <td>
                                {{ $smallBrothers->user->email ?? '' }}
                            </td>
                            <td>
                                {{ $smallBrothers->user->name ?? '' }}
                            </td>
                            <td>
                                {{ $smallBrothers->user->phone ?? '' }}
                            </td> 
                            <td>
                                {{ $smallBrothers->user->identity_number }}
                            </td>
                            <td>
                                {{ $smallBrothers->user->identity_date }}
                            </td>
                            <td>
                                {{ $smallBrothers->user->dbo }}
                            </td>
