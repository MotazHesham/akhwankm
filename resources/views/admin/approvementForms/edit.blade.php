    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.approvement-forms.update", [$approvementForm->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('approved') ? 'is-invalid' : '' }}" type="number" name="approved" id="approved" value="{{ old('approved', $approvementForm->approved) }}" step="1" required>
