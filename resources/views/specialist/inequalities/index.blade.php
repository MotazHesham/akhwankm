            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Inequality">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.inequality.fields.applicant') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($inequalities as $key => $inequality)
                        <tr data-entry-id="{{ $inequality->id }}">
                            ...
                            <td>
                            {{(App\Models\User::findOrfail($inequality->user_id)->user_type)}}
                            </td>
                            <td>
                                    <a class="btn btn-xs btn-primary" href="{{ route('specialist.inequalities.show', $inequality->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                      
                                    <a class="btn btn-xs btn-info" href="{{ route('specialist.inequalities.print', $inequality->id) }}">
                                        {{ trans('global.print') }}
                                    </a>
