...
<body style="background-color: white">
    ...
    <h1 style=" text-align:center" ><b> <ins> تعاقد بين الأخ الأكبر/الأخت الكبرى مع الأخ الأصغر/ الأخت الصغرى </ins></b></h1>
...
<div style="display: flex; justify-content: center;">
    <div style="border: 1px solid #000; width: 20cm;">
        ...
        <table style="padding: 1.5rem;float: right;position: relative;">
			<tr>
				<td class="text-right "  ><span >{{$big_brother->user->identity_number ?? ''}}</span> <label class="gry-color strong selectBoxLabel bold block" style="float:right"> : رقم الهوية &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
				<td class="text-right " ><span >{{$big_brother->user->name ?? ''}}</span> <label class="gry-color strong" style="float:center" >: أناالأخ الأكبر&nbsp;&nbsp;</label></td>
			    <td class="text-right " ><span >{{$brothersDealForm->day}}</span> <label class="gry-color strong" style="float:right" >: إنه في يوم &nbsp;&nbsp;</label></td>
			</tr>
            <tr>
				<td class="text-right "  ><span >{{$small_brother->user->identity_number ?? ''}}</span> <label class="gry-color strong selectBoxLabel bold block" style="float:right"> : رقم الهوية &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
				<td class="text-right " ><span ></span>{{$small_brother->user->name}}<label class="gry-color strong" style="float:center" >:  تم التعاقد مع  الأخ الأصغر&nbsp;&nbsp;</label></td>
			...
			<div class="row">
				...
				<table style="padding: 1.5rem;float: right;position: relative; margin-top:50px;">
					...
					<tr>
						...
						<td class="text-right " >{{$brothersDealForm->specialist->email ?? ''}}<span ></span> <label class="gry-color strong" style="float:right" >:    الإخصائي الإجتماعي &nbsp;&nbsp;</label></td>
					</tr>
					<tr>
