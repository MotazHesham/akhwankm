            ...
            <div style="display: flex; justify-content: center;">
                <div style="width: 21.59cm; height: 30cm ;">
                    ...
                    <a class="btn btn-success"
                        href="{{ route('bigbrother.BrothersPromiseForm.printForm', $bigBrother->id) }}">
                        {{ trans('global.print') }}
                    </a>
                    ...
                    <h2 style="background-color: #DDD ; text-align:center"> <span>استمارة رقم</span> ({{ $bigBrother->id }})
                    </h2>
                    <br>
                    <br>
                    <div style="display: flex; justify-content: center;">
                                ...
                                <b>
                                    <ol style="list-style-type:arabic-indic ;direction:RTL; text-align: right;">
                                        ...
                                        <li> إن اختار الأخ الأخ الأكبر/الأخت اكبرى السيناريو ( 2 ) في سلم التآخي يكون أختلاط
                                            الأخ الأصغر/ الأخت الصغرى مع نفس الجنس من أبناء أسرة الأخ الأكبر/ الأخت الكبرى
                                        </li>
                                    </ol>
                                </b>
