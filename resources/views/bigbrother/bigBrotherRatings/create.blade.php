...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.bigBrotherRating.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("bigbrother.big-brother-ratings.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\BigBrotherRating::EVALUATION_PROCEDURES_PROVIDED_BY_SPECIALIST_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('evaluation_procedures_provided_by_specialist') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="evaluation_procedures_provided_by_specialist_{{ $key }}" name="evaluation_procedures_provided_by_specialist" value="{{ $key }}" {{ old('evaluation_procedures_provided_by_specialist', '') === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\BigBrotherRating::EVALUATION_OF_REQUIRED_INTERVIEWS_WITH_SPECIALIST_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('evaluation_of_required_interviews_with_specialist') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="evaluation_of_required_interviews_with_specialist_{{ $key }}" name="evaluation_of_required_interviews_with_specialist" value="{{ $key }}" {{ old('evaluation_of_required_interviews_with_specialist', '') === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\BigBrotherRating::SATISFACTION_WITH_THE_ACCEPTANCE_OF_THE_SMALLER_BROTHER_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('satisfaction_with_the_acceptance_of_the_smaller_brother') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="satisfaction_with_the_acceptance_of_the_smaller_brother_{{ $key }}" name="satisfaction_with_the_acceptance_of_the_smaller_brother" value="{{ $key }}" {{ old('satisfaction_with_the_acceptance_of_the_smaller_brother', '') === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\BigBrotherRating::QUALITY_OF_OFFERED_PROGRAMS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('quality_of_offered_programs') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="quality_of_offered_programs_{{ $key }}" name="quality_of_offered_programs" value="{{ $key }}" {{ old('quality_of_offered_programs', '') === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\BigBrotherRating::EVALUATE_STUDY_OF_CHALLENGES_AND_FIND_HELPFUL_SOLUTIONS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('evaluate_study_of_challenges_and_find_helpful_solutions') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="evaluate_study_of_challenges_and_find_helpful_solutions_{{ $key }}" name="evaluate_study_of_challenges_and_find_helpful_solutions" value="{{ $key }}" {{ old('evaluate_study_of_challenges_and_find_helpful_solutions', '') === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\BigBrotherRating::ASSESSMENT_OF_THE_INTERACTION_OF_THE_SMALLER_BROTHER_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('assessment_of_the_interaction_of_the_smaller_brother') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="assessment_of_the_interaction_of_the_smaller_brother_{{ $key }}" name="assessment_of_the_interaction_of_the_smaller_brother" value="{{ $key }}" {{ old('assessment_of_the_interaction_of_the_smaller_brother', '') === (string) $key ? 'checked' : '' }} required>
            ...
            {{-- <div class="form-group">
                <label class="required" for="big_brother_id">{{ trans('cruds.bigBrotherRating.fields.big_brother') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.bigBrotherRating.fields.big_brother_helper') }}</span>
            </div> --}}
            <div class="form-group">
