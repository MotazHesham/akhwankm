...
return [
    ...
    'flash' => [
        ...
        'city' => [
            'status' => 'تم تعديل حالة المدينة بنجاح',
            'success' => 'تم اضافة المدينة جديدة بنجاح ',
            'updated' => "تم التعديل بنجاح",
            'deleted' => "تم الحذف بنجاح",
            'mass_destroy' => "تم حذف جميع المدن بنجاح",
        ],
        'skill' => [
            'status' => 'تم تعديل حالة المهارة بنجاح',
            'success' => 'تم اضافة المهارة بنجاح ',
            'updated' => "تم التعديل بنجاح",
            'deleted' => "تم الحذف بنجاح",
            'mass_destroy' => "تم حذف جميع المهارات بنجاح",
        ],
        'role' => [
            'success' => "تم اضافة دور جديد بنجاح ",
            'updated' => "تم التعديل بنجاح",
            'deleted' => "تم الحذف بنجاح",
            'mass_destroy' => "تم حذف جميع الأدوار بنجاح",
        ],
        'user_alert' => [
            'success' => "تم ارسال اشعار للمستخدمين بنجاح ",
            'updated' => "تم التعديل بنجاح",
            'deleted' => "تم الحذف بنجاح",
            'mass_destroy' => "تم حذف جميع الأشعارات بنجاح",
        ],
        'user' => [
            'approve' => "تم تعديل حالة المستخدم بنجاح",
            'success' => "تم اضافة مستخدم جديد بنجاح ",
            'updated' => "تم التعديل بنجاح",
            'deleted' => "تم الحذف بنجاح",
