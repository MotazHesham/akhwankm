...
class HomeController
{
    public function index()
    {
        ...
        $settings3 = [
            'chart_title'           => 'Brothers Deal Form',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
        ...
        $settings6 = [
            'chart_title'           => 'Latest Outing Request',
            'chart_type'            => 'latest_entries',
            'report_type'           => 'group_by_date',
        ...
        return view('home', compact('settings1', 'settings2', 'settings3', 'chart4', 'settings5', 'settings6'));
    }
}
